...
<head runat="server">
    <title>K11 - 香港K11購物藝術館</title>
    <link rel="stylesheet" type="text/css" href="/Styles/K11style.css" />
    <meta name="description" content="香港K11商場是全球首個購物藝術館。K11香港購物中心也是把藝術，人文，自然三大核心元素融合的香港藝術館。" /> 
    <meta name="keywords" content="尖沙嘴, 尖沙咀, TST, Tsimshatsui, Tsim Sha Tsui, 香港K11動態" /> 
...
<body>
    ...
    <webdiyer:AspNetPager ID="AspNetPager1" runat="server" Width="100%" UrlPaging="true" pagesize="100" CssClass="paginator"
        HorizontalAlign="Center" EnableTheming="true" ShowPageIndexBox="Never" CurrentPageButtonClass="cpb">
